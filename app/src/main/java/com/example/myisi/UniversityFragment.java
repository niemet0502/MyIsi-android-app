...
public class UniversityFragment extends Fragment implements OnMapReadyCallback {
    ...
    private GoogleMap mMap; //Un Objet qui recevra la carte Google Map
    ...
    //Quand la carte est prête à être affichée
    @Override
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                if(marker.getTitle().equalsIgnoreCase("ISI Mère"))
                {
                    ...
                    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:775667527"));
                    startActivity(intent);
                }
                if(marker.getTitle().equalsIgnoreCase("UCAD"))
                {
                    Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.parse("sms:775667527"));
